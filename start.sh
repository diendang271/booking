...
$DDB_PUT --item '{"BookingID": {"S": "test-booking-1"}, "Location": {"M": {"Latitude": {"N":"1.3521"}, "Longitude":{"N":"103.8198"}}}, "AgentID":{"S": "test-agent-1"}, "State":{"S": "NEW"}}'
$DDB_PUT --item '{"BookingID": {"S": "test-booking-2"}, "Location": {"M": {"Latitude": {"N":"1.3521"}, "Longitude":{"N":"103.8198"}}}, "AgentID":{"S": "test-agent-2"}, "State":{"S": "IN_PROGRESS"}}'
$DDB_PUT --item '{"BookingID": {"S": "test-booking-3"}, "Location": {"M": {"Latitude": {"N":"1.3521"}, "Longitude":{"N":"103.8198"}}}, "AgentID":{"S": "test-agent-3"}, "State":{"S": "COMPLETED"}}'
